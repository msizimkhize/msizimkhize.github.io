...
function startTypewriter() {
  ...
  const fullText = `Hello, World! I'm Msizi Mkhize, a software architect transitioning into data analytics after focusing on software engineering, software for pure and applied mathematics, machine learning and cybersecurity. I study at the University of South Africa and am in the process of completing my Bachelor of Science degree in Mathematics and Computer Science. \n\nThe projects I am working on are built in SQL, Python, R, Power BI, Excel, Google Colab and Tableau, with a focus on analysing intranational, financial and demographic data. My goal is to help businesses uncover insights and improve performance through comprehensive reporting and streamlined automation.`;
  el.textContent = '';
